...
<Navbar bool1={false}/>
 ...
 <div className="shadow-lg group hover:shadow-xl flex flex-col items-start justify-center gap-3 rounded-[10px]  h-[100px] w-[300px] bg-white">
   ...
   <div className="text-gray-800 text-sm ml-2">TRANSACTIONS</div>
    ...
    <div className="text-xl text-red-400 group-hover:text-blue-800">123.1 Million</div>

        </div>
    <div className="shadow-lg group hover:shadow-xl flex flex-col items-start justify-center gap-3 rounded-[10px]  h-[100px] w-[300px] bg-white">

        <div className="text-gray-800 text-sm ml-2 ">LATEST SUSPICIOUS(24h)</div>
    <div className="text-xl text-black group-hover:text-blue-800">20</div>

        </div>
    <div className="shadow-lg group hover:shadow-xl flex flex-col items-start justify-center gap-3 rounded-[10px]  h-[100px] w-[300px] bg-white">

        <div className="text-gray-800 text-sm ml-2">AVG SUSPICIOUS AMOUNT(24hrs)</div>
    <div className="text-xl text-black group-hover:text-blue-800">$10000</div>
       ...
       <div className='m-auto mt-[40px]  w-[90vw] min-h-[60vh] flex flex-col gap-[1px] bg-gray-100 rounded-[10px]'>
        <div className=' flex justify-between bg-white rounded-t-[10px] rounded-r-[10px] shadow-md mb-[1px] text-md p-5'>
           ...
           More than 50 suspicious transactions found
            </div> 
      ...
      {transactions.map(item=>{
        ...
        <div className=' w-[11%]   p-2  text-center rounded-[4px] m-auto'><div className='h-[25px] text-red-500 w-[120px] p-1 rounded-[10px] mb-[5px] bg-gray-300'>{item.method}</div></div>
